{
  busybox = import <nix/fetchurl.nix> {
    url = "http://artifacts.pdtpartners.com/artifactory/ftp-public/nix/bootstrap-files/ef4c1be6c7ae57e4f654efd90ae2d2e204d6769364c46469fa9ff3761195cba1/busybox";
