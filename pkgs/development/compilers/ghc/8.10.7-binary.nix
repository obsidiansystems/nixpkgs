...
let
  ...
  libPath = lib.makeLibraryPath ([
    ...
    ++ lib.optional (stdenv.hostPlatform.isAarch64 && !stdenv.hostPlatform.isDarwin) numactl);
...
stdenv.mkDerivation rec {
  ...
  # https://downloads.haskell.org/~ghc/8.10.7/
  src = fetchurl ({
    i686-linux = {
    ...
    armv7l-linux = {
      ...
      sha256 = "18jn148dmw24l9hrk3cqbmy71aacr9mj9a2yfvxllfvxvwdw6j9r";
    };
    aarch64-linux = {
      url = "${downloadsUrl}/${version}/ghc-${version}-aarch64-deb10-linux.tar.xz";
      sha256 = "0m8fklyqcd8xrmhwnimyhyg3b5h82kkc0yfyiazk6li9kdzl3lps";
    };
    x86_64-darwin = {
    ...
    aarch64-darwin = {
      ...
      sha256 = "075skdnsa072088a8jfkqac7pphkgzlgqpspb8xa7ljzqg1ryinw";
    };
  ...
  meta = rec {
    ...
    platforms = ["x86_64-linux" "armv7l-linux" "aarch64-linux" "i686-linux" "x86_64-darwin" "aarch64-darwin"];
