...
let
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."turtl-lib-permissions-git+https://github.com/turtl/lib-permissions.git#master"
      ...
      sources."xtend-4.0.2"
      sources."yaml-env-git+https://github.com/orthecreedence/yaml-env.git#master"
    ];
